def print_keyboard_instructions():
    print("To type \"m³\" (m3) on a keyboard, you typically use special characters or symbols. Here's how you can do it on different platforms:\n")
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("- While holding the Alt key, type 0179 on the numeric keypad.")
            ...
            print("- Search for \"superscript\" or \"superscript 3\".")
            ...
            print("- If configured, you can use the Compose key followed by ^3 to produce \"³\".\n")
